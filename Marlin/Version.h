 ...
 */
   ...
   */
  #define DETAILED_BUILD_VERSION "Geofferey@Github"
   ...
   */
  #define MACHINE_NAME "Ender3 Pro v1.5"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/geofferey/Marlin"
   ...
   */
  #define WEBSITE_URL "https://github.com/geofferey/Marlin"
